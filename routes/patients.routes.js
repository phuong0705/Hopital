...
router.get('/reception', requireRole(['ADMIN', 'RECEPTIONIST', 'NURSE']), patientsController.receptionForm);
router.post('/reception', requireRole(['ADMIN', 'RECEPTIONIST', 'NURSE']), patientsController.createAdmission);
